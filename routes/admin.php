...
$app->group('/admin', function() use($app) {
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('product', $role)) return $next($request, $response);
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('order', $role)) return $next($request, $response);
    return $response->withStatus(302)->withHeader('Location', '/404');
  });
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('customer', $role)) return $next($request, $response);
    return $response->withStatus(302)->withHeader('Location', '/404');
  });
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('article', $role)) return $next($request, $response);
    return $response->withStatus(302)->withHeader('Location', '/404');
  });
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('setting', $role)) return $next($request, $response);
    return $response->withStatus(302)->withHeader('Location', '/404');
  });
  ...
  $app->group('', function () use ($app) {
    ...
    $role = $_SESSION['role'];
    if(in_array('staff', $role)) return $next($request, $response);
    return $response->withStatus(302)->withHeader('Location', '/404');
  });
